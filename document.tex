...
The heatmap (Figure \ref{fig:04}) reveals some square patches around the central diagonal;
...
\caption{Pairwise comparison of MoAs similarities. Only the first level of 
...
which appears as ``B'' (dark orange) on the plot.
Some compounds belong to multiple ATC categories (Mulitple - black) and some others do not have
an ATC code (NoCategory - white)
...
based on the overall similarity of their actions (letters on Figure \ref{fig:05}).
...
action that could impact Alzheimer's disease. The categories have been manually picked on the basis that they could directly affect
the dementia. Drugs classified in these FTC categories further 
manually grouped based on their MoAs similarities (subgroups B, C, D, E and G).}\label{fig:05}
\end{figure}
 
The subgroups B, C and D are inhibitors of the cholinergic system and some of them, such as \emph{galantamine} (DB00674), are already 
...
The group F contains four compounds; \emph{nicotine} and \emph{varenicline} have been further grouped together because of 
similar pharmacology (group G).
...
disease \citep{Grundke-Iqbal1986}. \emph{Vorinostat} (group H) is currently 
...
deficit \citep{Kilgore2010}. The presence of \emph{lithium} (group I) was 
...
the treatment of a given set of symptoms or dysfunctionning biological processes.
...
initiatives or enhance computational studies making use of the concept of \emph{mode of action}. The construction of 
