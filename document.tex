...
\section{Motivation:}
Drug repurposing is the discovery of new indications for compounds that have already been approved and used in a clinical setting. 
...
\caption{The diagram gives an overview of the integrated resources. (A) The name of FTC categories representing MoAs are derived from the GO terms representing the molecular 
functions and biological processes. A 
prefix \emph{anti} or \emph{pro} is appended to the original 
GO term, as well as the word \emph{agent} as suffix. (B) Each of the new FTC class has a logical
...
The population step takes in account the type of pharmacological action, the molecular targets of the drug and their involvement
...
present both in the FTC category and in the corresponding ATC categori(es). The total number of compounds from an ATC category but 
